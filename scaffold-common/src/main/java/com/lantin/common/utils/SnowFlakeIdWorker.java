...
public class SnowFlakeIdWorker {
    ...
    /**
     * 开始时间戳，单位毫秒；这里是2022-04-12
     */
    private static final long TW_EPOCH = 1649692800000L;
    ...
    public static void main(String[] args) {
        ...
        System.out.println((4094+1)&4095);
        ...
        Date date = new Date(2199023255552L);

        System.out.println(date);

    }

    private static String toBinary(long a) {
